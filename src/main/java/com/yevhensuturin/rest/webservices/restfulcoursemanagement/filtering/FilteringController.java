package com.yevhensuturin.rest.webservices.restfulcoursemanagement.filtering;
...
public class FilteringController {
    ...
    public MappingJacksonValue retrieveListOfSomeBeanDynamicFiltering(){
        List<SomeBean> someBeans = Arrays.asList(new SomeBean[]{new SomeBean("value1", "value2", "value3"),
